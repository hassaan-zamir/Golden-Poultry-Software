  ...
  return (
    <>
      ...
      >
        ...
        {filteredInvoices.length > 0 ? <section style={{ background: "white", color: "black", display: 'flex', justifyContent: 'center' }}>
          <table
          ...
          >
            <tbody>
              ...
              <tr>
                <th colSpan={4}>Comission Report</th>
              </tr>
              ...
              <tr>
                ...
                <td colSpan={2}>
                  <span>
                    {numberWithCommas(getTotalCommission(filteredInvoices))}
                  </span>
                </td>
              </tr>
            </tbody>
          </table>
        </section> : <p>No Invoices Found</p>}
      </div>
    </>
  );
}
