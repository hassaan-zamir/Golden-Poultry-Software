...
export default function DeliveryChallan({ invoice, printInvoice, setPrintInvoice }: DeliveryChallanPropTypes) {
        ...
        <tbody>
          ...
          <tr>
            <td colSpan={4}>
              ...
              <br />
              <span>{
               invoice.paid? 0 : (((invoice.todays_rate + invoice.add_less)*(invoice.second_weight - invoice.first_weight))-(invoice.cash + invoice.online))
              }</span>
            </td>
